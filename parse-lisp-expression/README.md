<h2>736. Parse Lisp Expression</h2><h3>Hard</h3><hr><div><p>You are given a string expression representing a Lisp-like expression to return the integer value of.</p>
